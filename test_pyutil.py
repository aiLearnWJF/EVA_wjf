...
PRETRAINED_L=['/mnt/pfs/data/yckj1563/projects/EVA_wjf/EVA-CLIP/rei/logs/2023_06_01-11_22_01-model_EVA02-CLIP-B-16-lr_0.00034-b_3200-j_8-p_amp_bf16']
DATA_PATH="/mnt/pfs/data/yckj1563/data/imagenet/val/"
EpochNums_per_model = 10
# cd EVA-CLIP/rei
...
for PRETRAINED in PRETRAINED_L:
    for ep in range(EpochNums_per_model):
        ...
        mycmd = "export CUDA_VISIBLE_DEVICES='6' && export PYTHONPATH='/vehicle/yckj3860/code/EVA_wjf/EVA-CLIP/rei' && cd EVA-CLIP/rei && /mnt/pfs/data/yckj1563/miniconda3/envs/py37_torch1_7_evaclip/bin/python -m torch.distributed.launch --nproc_per_node=1 --nnodes=1 --node_rank=0 --master_addr='localhost' --master_port=12363 --use_env training/main.py --imagenet-val %s --model %s --pretrained %s --force-custom-clip  --batch-size=512 && sleep 20"%( DATA_PATH,MODEL_NAME,pretrained_path)
