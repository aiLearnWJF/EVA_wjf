...
PRETRAINED_IMAGE=openai #/home/yckj3860/.cache/huggingface/hub/models--QuanSun--EVA-CLIP/snapshots/63d255690a20d26438e10737a86246a94e8cc2c1/EVA02_CLIP_B_psz16_s8B.pt
PRETRAINED_TEXT=openai #/home/yckj3860/.cache/clip/ViT-B-16.pt
# PRETRAINED_VISUAL_MODEL=EVA02-B-16
PRETRAINED_VISUAL_MODEL=OpenaiCLIP-B-16
...
cd EVA-CLIP/rei
# export WORLD_SIZE=1
/vehicle/yckj3860/miniconda3/envs/py37_torch1_7_evaclip/bin/python -m torch.distributed.launch --nproc_per_node=1 \
